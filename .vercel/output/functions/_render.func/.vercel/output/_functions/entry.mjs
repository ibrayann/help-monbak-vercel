...
const pageMap = new Map([
    ...
    ["src/pages/posts/el-café-combustible-esencial-para-la-vida-cotidiana.md", _page2],
    ["src/pages/posts/explorando-los-potenciales-terapéuticos-el-uso-medicinal-del-cannabis-sativa.md", _page3],
    ["src/pages/posts/inteligencia-artificial-en-medicina.md", _page4],
    ["src/pages/posts/inteligencia-artificial-y-ética.md", _page5],
    ["src/pages/posts/iron-man-el-mejor-vengador.md", _page6],
    ["src/pages/posts/telemedicina-y-atención-remota.md", _page7],
